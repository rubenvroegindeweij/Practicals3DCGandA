// 3DCGandA2.cpp : Defines the entry point for the console application.
//
...
// Here you can add functionality concerning this practical
// Important: 'key' contains the character that was pressed in the keyboard
...
/************************************************************
* OpenGL management functions. Do not modify
************************************************************/
void display(void)
{
	glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT); // la couleur et le z
